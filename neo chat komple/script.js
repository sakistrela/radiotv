...
function updateUserList() {
  ...
  usersArray.forEach(u => {
    ...
    const unreadBadge = unreadPrivateMessages[uid] ? `<span class="unread-badge">${unreadPrivateMessages[uid]}</span>` : '';
...
function subscribeToMessages() {
  // ΚΡΙΣΙΜΟ: Καθαρισμός ΟΛΩΝ των παλιών listeners πριν βάλουμε νέους
  db.ref('messages').off();
